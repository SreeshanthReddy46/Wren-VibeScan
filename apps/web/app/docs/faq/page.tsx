...
export default function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: "When running the local CLI (`npx wren-security check .`), your code is evaluated locally on your computer and never uploaded or stored on any server. If you use the cloud dashboard, only high-level finding metadata (rule name, file path, line number) is synced.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes! You can run local scans on your computer with `npx wren-security check .` completely free without creating an account.",
    },
  ];
